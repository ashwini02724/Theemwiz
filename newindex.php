    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container">
            ...
            <div class="nav-link" style="display:flex;">
                ...
                <h4>welcome user<?php echo $_SESSION['email'];?></h4>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="text-center text-white">
                        ...
                        <!-- to get an API token!-->
                        <form action="email.php" method="post" class="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <!-- Email address input-->
                            <div class="row">
                                <div class="col">
                        ...
                        <div class="form-wrap">
                            <form action="login.php" method="post" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="email" id="validationCustom01" value=""
                                        required>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary" input type="submit">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="form-wrap">
                            <form action="connect.php" method="post" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="phone_no" id="validationCustom06" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" name="email" id="validationCustom03" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="password" class="form-control" name="password" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="password" class="form-control" name="confirm_password" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                  </div>
                                  <div class="col-12">
                                    <div class="form-check">
                                      <input class="form-check-input" type="checkbox" name="check_box" value="" id="invalidCheck" required>
                                      <label class="form-check-label" for="invalidCheck">
                                ...
                                <button class="btn btn-primary" input type="submit">Sign Up</button>
                                    <!-- <script>
                                            function myFunction() {
                                                alert("Registration sucessfully....0");
                                            }
                                    </script> -->
                                </div>
                            </form>
